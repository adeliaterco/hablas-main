...
const loadVTurbScript = () => {
  if (!document.querySelector('script[src*="69170bc198db0a5ed75eb411"]')) {
    const script = document.createElement("script")
    script.src = "https://scripts.converteai.net/9c43125c-42f3-489c-b79f-8814b94ee357/players/69170bc198db0a5ed75eb411/v4/player.js"
    script.async = true
              ...
              <div className="w-full max-w-3xl">
                <div className="relative bg-black rounded-xl sm:rounded-2xl mobile-video-padding mobile-border-orange shadow-2xl w-full">
                  ...
                  <div className="relative z-10 w-full mobile-video-container">
                    <vturb-smartplayer 
                      id="vid-69170bc198db0a5ed75eb411" 
